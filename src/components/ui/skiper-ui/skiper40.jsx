...
const Link000 = ({
  ...
  // Use "to" instead of "href" for react-router-dom Link if it's internal.
  // But if it's a mailto or external link, we should use a standard <a> tag.
  // Since we don't know the exact intent for Link000, we'll keep it as Link but use `to`.
  return (
    <Link
      to={href}
      className={cn(
