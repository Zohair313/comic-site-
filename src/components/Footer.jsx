        ...
        <div className="row g-4">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="d-flex gap-3">
              <a href="https://instagram.com/wessley_stangle" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#e8e4db', transition: 'color 0.2s', display: 'inline-flex', width: '44px', height: '44px', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={(e) => e.currentTarget.style.color = '#ED3833'} onMouseLeave={(e) => e.currentTarget.style.color = '#e8e4db'}>
                <i className="fa-brands fa-instagram" style={{ fontSize: '1.4rem' }}></i>
              </a>
              <a href="mailto:Wolf.357.lord@gmail.com" aria-label="Email" style={{ color: '#e8e4db', transition: 'color 0.2s', display: 'inline-flex', width: '44px', height: '44px', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={(e) => e.currentTarget.style.color = '#ED3833'} onMouseLeave={(e) => e.currentTarget.style.color = '#e8e4db'}>
