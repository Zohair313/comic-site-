      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="font-black tracking-widest uppercase text-sm mb-2 block" style={{ color: '#ED3833' }}>My Journey</span>
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            {timeline.map((item, idx) => (
              <div className={`relative flex flex-col md:flex-row items-center justify-between mb-12 ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''}`} key={idx}>
                ...
                {/* Timeline Dot */}
                <div className="absolute left-[16px] md:left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full border-4 border-white shadow-sm z-10" style={{ backgroundColor: '#ED3833' }}></div>
                ...
                <div className="w-full pl-20 md:pl-0 md:w-5/12">
                  <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    <span className="inline-block px-4 py-1 font-bold text-sm uppercase tracking-wider rounded-full mb-4" style={{ backgroundColor: 'rgba(237, 56, 51, 0.1)', color: '#ED3833' }}>{item.year}</span>
      ...
      <section className="pb-24">
        <div className="container mx-auto px-4">
          <div className="bg-zinc-900 rounded-3xl p-10 md:p-16 relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between">
            {/* Background Accent */}
            <div className="absolute top-0 right-0 w-96 h-96 rounded-full blur-[120px] opacity-20 transform translate-x-1/3 -translate-y-1/3" style={{ backgroundColor: '#ED3833' }}></div>
            ...
            <div className="relative z-10 md:w-1/3 text-center md:text-right">
              <Link to="/support" className="inline-flex items-center justify-center px-8 py-4 text-white font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-[rgba(237,56,51,0.4)]" style={{ backgroundColor: '#ED3833' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#c92825'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#ED3833'}>
